...
- Frontend runs on <a href="http://localhost:3006" target="_blank">http://localhost:3006</a>
- API runs on <a href="http://localhost:3008" target="_blank">http://localhost:3008</a>
